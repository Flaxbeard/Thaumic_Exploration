...
import flaxbeard.thaumicexploration.ai.EntityAILoveOwnerHurtByTarget;
import flaxbeard.thaumicexploration.ai.EntityAILoverOwnerHurtTarget;
import flaxbeard.thaumicexploration.ai.EntityAINearestAttackablePureTarget;

public class EntityLoveArrow extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityLoveArrow(World par1World)
    {
        super(par1World);
    ...
    public EntityLoveArrow(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)i1))
                    {
                        if (movingobjectposition.entityHit instanceof EntityLivingBase)
                        {
                            EntityLivingBase entitylivingbase = (EntityLivingBase)movingobjectposition.entityHit;
                    			...
                    			System.out.println("FEEL THE LOVE");
                    			mob.setAttackTarget(null);
                    			mob.getEntityData().setInteger("loveOwnerID", this.shootingEntity.entityId);
                    			mob.targetTasks.addTask(-1, new EntityAILoveOwnerHurtByTarget((EntityCreature) mob)); 
                    			mob.targetTasks.addTask(0, new EntityAILoverOwnerHurtTarget((EntityCreature) mob));
                       			mob.tasks.addTask(-1, new EntityAIAttackOnCollide((EntityCreature) mob, 1.0D, false)); 
