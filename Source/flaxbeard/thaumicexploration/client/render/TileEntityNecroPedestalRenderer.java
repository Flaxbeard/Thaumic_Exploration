		...
		//ystem.out.println(highestFilledSlot);
         for (int i = 0; i<6; i++) {
	         if (replicator.getStackInSlot(i) != null) {
		         ...
		         if (((replicator.getStackInSlot(i).getItem() instanceof ItemBlock)) && (replicator.getStackInSlot(i).itemID < Block.blocksList.length)) {
		         ...
		         is.stackSize = 1;
		         entityitem = new EntityItem(replicator.worldObj, 0.0D, 0.0D, 0.0D, is);
