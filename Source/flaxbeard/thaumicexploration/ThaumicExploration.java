...
//		floatCandleID = config.getBlock("Floating Candles", 712).getInt();
	...
	public void load(FMLInitializationEvent event) {
	   ...
	   // this.entityEventHandler2 = new TXArmorEventHandler();
		...
		WAND_ROD_CRYSTAL = new WandRodTransmutative("TRANSMUTATION",100,new ItemStack(ThaumicExploration.transmutationCore),1,new WandRodTransmutationOnUpdate(), new ResourceLocation("thaumicexploration:textures/models/0.png"));
