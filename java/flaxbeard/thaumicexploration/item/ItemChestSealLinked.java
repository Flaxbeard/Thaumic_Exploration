...
//    }
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
	    if (par1ItemStack.hasTagCompound()) {
	    	...
	    	par3List.add("Linked to " + par1ItemStack.stackTagCompound.getInteger("x") + "," + par1ItemStack.stackTagCompound.getInteger("y") + "," + par1ItemStack.stackTagCompound.getInteger("z") + " in the " + dimension + " (Network " + par1ItemStack.stackTagCompound.getInteger("ID") + ")");
	    }
    }
